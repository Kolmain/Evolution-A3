...
_tskDescription = format ["Destroy %1's communications tower. Until this is completed, OPFOR reinforcements will continue to arrive from %2.", currentTargetName, text (targetLocations select (targetCounter + 1))];
