...
[WEST, [towerTask, attackTask], [_tskDisplayName, _tskDisplayName, currentTargetMarkerName], (getMarkerPos currentTargetMarkerName), 1, 2, true] call BIS_fnc_taskCreate;
