...
bon_recruit_recruitableunits = ["CUP_B_US_Soldier_Backpack","B_Soldier_GL_F","B_soldier_AR_F","B_soldier_M_F","B_soldier_LAT_F","B_medic_F","B_soldier_repair_F","B_soldier_exp_F","B_Helipilot_F","B_engineer_F","B_soldier_AT_F","B_soldier_AA_F","B_helicrew_F"];
bon_recruit_queue = [];
